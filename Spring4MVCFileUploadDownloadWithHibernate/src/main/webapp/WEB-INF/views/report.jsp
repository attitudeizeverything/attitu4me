				...
				<table class="table table-hover">
		    		...
		    		<tbody>
						...
						<tr>
							...
							<%-- 
							<td><a href="<c:url value='/download-document-${user.id}-${doc.userDocument.id}' />" class="btn btn-success custom-width">download</a></td>
							<td><a href="<c:url value='/delete-document-${user.id}-${doc.userDocument.id}' />" class="btn btn-danger custom-width">delete</a></td>
						 --%></tr>
					</c:forEach>
		    		</tbody>
		    	</table>
