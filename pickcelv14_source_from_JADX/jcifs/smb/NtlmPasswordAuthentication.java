...
public final class NtlmPasswordAuthentication implements Principal, Serializable {
    ...
    static {
        ...
        S8 = new byte[]{(byte) 75, (byte) 71, (byte) 83, (byte) 33, (byte) 64, (byte) 35, (byte) 36, (byte) 37};
    ...
    private static void m128E(byte[] key, byte[] data, byte[] e) {
    ...
    public static byte[] getNTLM2Response(byte[] nTOWFv1, byte[] serverChallenge, byte[] clientChallenge) {
        ...
        try {
            ...
            m128E(key, sessionHash, ntResponse);
            return ntResponse;
    ...
    public static byte[] getNTLMv2Response(byte[] responseKeyNT, byte[] serverChallenge, byte[] clientChallenge, long nanos1601, byte[] targetInfo) {
        ...
        Encdec.enc_uint32le(MKeyEvent.KEYCODE_LIST, temp, 0);
        ...
        while (i < len) {
            ...
            switch (state) {
                case SID.SID_TYPE_USE_NONE /*0*/:
                    ...
                    break;
                case SmbNamedPipe.PIPE_TYPE_RDONLY /*1*/:
                    b[0] = (byte) (Integer.parseInt(str.substring(i, i + 2), 16) & MKeyEvent.KEYCODE_SLEEP);
                    j2 = j + 1;
