...
abstract class SmbComTransaction extends ServerMessageBlock implements Enumeration {
    ...
    static {
        DEFAULT_MAX_DATA_COUNT = Config.getInt("jcifs.smb.client.transaction_buf_size", TRANSACTION_BUF_SIZE) - 512;
    }
    ...
    SmbComTransaction() {
        ...
        this.name = "";
        this.maxParameterCount = HttpTransport.DEFAULT_CHUNK_LENGTH;
