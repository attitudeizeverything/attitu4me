...
abstract class AndXServerMessageBlock extends ServerMessageBlock {
    ...
    int writeAndXWireFormat(byte[] dst, int dstIndex) {
        ...
        dst[start] = (byte) (this.wordCount & MKeyEvent.KEYCODE_SLEEP);
        ...
        dst[i] = (byte) ((this.byteCount >> 8) & MKeyEvent.KEYCODE_SLEEP);
        ...
        if (this.andx instanceof AndXServerMessageBlock) {
            ...
            dst[andxStart] = (byte) (this.andx.wordCount & MKeyEvent.KEYCODE_SLEEP);
            this.andx.byteCount = this.andx.writeBytesWireFormat(dst, dstIndex + ANDX_RESERVED_OFFSET);
            i = dstIndex + ANDX_COMMAND_OFFSET;
            dst[dstIndex] = (byte) (this.andx.byteCount & MKeyEvent.KEYCODE_SLEEP);
            dstIndex = i + ANDX_COMMAND_OFFSET;
            dst[i] = (byte) ((this.andx.byteCount >> 8) & MKeyEvent.KEYCODE_SLEEP);
    ...
    int readAndXWireFormat(byte[] buffer, int bufferIndex) {
        ...
        if (this.wordCount != 0) {
            ...
            this.andxOffset = ServerMessageBlock.readInt2(buffer, bufferIndex2 + ANDX_RESERVED_OFFSET);
            ...
            bufferIndex = (start + ANDX_COMMAND_OFFSET) + (this.wordCount * ANDX_RESERVED_OFFSET);
        } else {
        ...
        if (this.errorCode != 0 || this.andxCommand == (byte) -1) {
            ...
            if (this.andx instanceof AndXServerMessageBlock) {
                ...
                buffer[bufferIndex] = (byte) (this.andx.wordCount & MKeyEvent.KEYCODE_SLEEP);
    ...
    public String toString() {
        return new String(super.toString() + ",andxCommand=0x" + Hexdump.toHexString(this.andxCommand, (int) ANDX_RESERVED_OFFSET) + ",andxOffset=" + this.andxOffset);
    }
}
