...
public class UUID extends uuid_t {
    ...
    private static byte m356B(int i) {
        return (byte) (i & MKeyEvent.KEYCODE_SLEEP);
    }

    private static short m357S(int i) {
    ...
    public UUID(String str) {
        ...
        this.time_mid = m357S(hex_to_bin(arr, 9, 4));
        this.time_hi_and_version = m357S(hex_to_bin(arr, 14, 4));
        this.clock_seq_hi_and_reserved = m356B(hex_to_bin(arr, 19, 2));
        this.clock_seq_low = m356B(hex_to_bin(arr, 21, 2));
        this.node = new byte[6];
        this.node[0] = m356B(hex_to_bin(arr, 24, 2));
        this.node[1] = m356B(hex_to_bin(arr, 26, 2));
        this.node[2] = m356B(hex_to_bin(arr, 28, 2));
        this.node[3] = m356B(hex_to_bin(arr, 30, 2));
        this.node[4] = m356B(hex_to_bin(arr, 32, 2));
        this.node[5] = m356B(hex_to_bin(arr, 34, 2));
    }
