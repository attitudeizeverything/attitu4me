...
public class samr {
    ...
    public static class SamrRidWithAttributeArray extends NdrObject {
        ...
        public void encode(NdrBuffer _dst) throws NdrException {
            ...
            _dst.enc_ndr_referent(this.rids, samr.SE_GROUP_MANDATORY);
            if (this.rids != null) {
                _dst = _dst.deferred;
                int _ridss = this.count;
                _dst.enc_ndr_long(_ridss);
                int _ridsi = _dst.index;
                _dst.advance(_ridss * samr.SE_GROUP_OWNER);
                _dst = _dst.derive(_ridsi);
                for (int _i = 0; _i < _ridss; _i += samr.SE_GROUP_MANDATORY) {
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_src.dec_ndr_long() != 0) {
                ...
                _src.advance(_ridss * samr.SE_GROUP_OWNER);
                if (this.rids == null) {
                    if (_ridss < 0 || _ridss > SupportMenu.USER_MASK) {
    ...
    public static class SamrSamArray extends NdrObject {
        ...
        public void encode(NdrBuffer _dst) throws NdrException {
            _dst.align(samr.SE_GROUP_ENABLED);
            _dst.enc_ndr_long(this.count);
            _dst.enc_ndr_referent(this.entries, samr.SE_GROUP_MANDATORY);
            if (this.entries != null) {
                ...
                for (int _i = 0; _i < _entriess; _i += samr.SE_GROUP_MANDATORY) {
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_src.dec_ndr_long() != 0) {
                ...
                if (this.entries == null) {
                    if (_entriess < 0 || _entriess > SupportMenu.USER_MASK) {
                        throw new NdrException(NdrException.INVALID_CONFORMANCE);
                    }
    ...
    public static class SamrSamEntry extends NdrObject {
        ...
        public void encode(NdrBuffer _dst) throws NdrException {
            ...
            _dst.enc_ndr_referent(this.name.buffer, samr.SE_GROUP_MANDATORY);
            if (this.name.buffer != null) {
                _dst = _dst.deferred;
                int _name_bufferl = this.name.length / samr.SE_GROUP_ENABLED_BY_DEFAULT;
                _dst.enc_ndr_long(this.name.maximum_length / samr.SE_GROUP_ENABLED_BY_DEFAULT);
                _dst.enc_ndr_long(0);
                _dst.enc_ndr_long(_name_bufferl);
                int _name_bufferi = _dst.index;
                _dst.advance(_name_bufferl * samr.SE_GROUP_ENABLED_BY_DEFAULT);
                _dst = _dst.derive(_name_bufferi);
                for (int _i = 0; _i < _name_bufferl; _i += samr.SE_GROUP_MANDATORY) {
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_src.dec_ndr_long() != 0) {
                ...
                _src.advance(_name_bufferl * samr.SE_GROUP_ENABLED_BY_DEFAULT);
                if (this.name.buffer == null) {
    ...
    public static class SamrCloseHandle extends DcerpcMessage {
        ...
        public int getOpnum() {
            return samr.SE_GROUP_MANDATORY;
        }
    ...
    public static class SamrConnect2 extends DcerpcMessage {
        ...
        public void encode_in(NdrBuffer _dst) throws NdrException {
            _dst.enc_ndr_referent(this.system_name, samr.SE_GROUP_MANDATORY);
