...
public class netdfs {
    ...
    public static class DfsEnumArray1 extends NdrObject {
        public int count;
        public DfsInfo1[] f140s;

        public void encode(NdrBuffer _dst) throws NdrException {
            _dst.align(netdfs.DFS_STORAGE_STATE_ACTIVE);
            _dst.enc_ndr_long(this.count);
            _dst.enc_ndr_referent(this.f140s, netdfs.DFS_STORAGE_STATE_OFFLINE);
            if (this.f140s != null) {
                _dst = _dst.deferred;
                int _ss = this.count;
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_src.dec_ndr_long() != 0) {
                ...
                if (this.f140s == null) {
                    if (_ss < 0 || _ss > SupportMenu.USER_MASK) {
                        throw new NdrException(NdrException.INVALID_CONFORMANCE);
                    }
                    this.f140s = new DfsInfo1[_ss];
                }
                _src = _src.derive(_si);
                for (int _i = 0; _i < _ss; _i += netdfs.DFS_STORAGE_STATE_OFFLINE) {
                    if (this.f140s[_i] == null) {
                        this.f140s[_i] = new DfsInfo1();
                    }
                    this.f140s[_i].decode(_src);
                }
            }
        }
    }
    ...
    public static class DfsEnumArray200 extends NdrObject {
        public int count;
        public DfsInfo200[] f141s;

        public void encode(NdrBuffer _dst) throws NdrException {
            _dst.align(netdfs.DFS_STORAGE_STATE_ACTIVE);
            _dst.enc_ndr_long(this.count);
            _dst.enc_ndr_referent(this.f141s, netdfs.DFS_STORAGE_STATE_OFFLINE);
            if (this.f141s != null) {
                _dst = _dst.deferred;
                int _ss = this.count;
                _dst.enc_ndr_long(_ss);
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_src.dec_ndr_long() != 0) {
                ...
                if (this.f141s == null) {
                    ...
                    this.f141s = new DfsInfo200[_ss];
                }
                _src = _src.derive(_si);
                for (int _i = 0; _i < _ss; _i += netdfs.DFS_STORAGE_STATE_OFFLINE) {
                    if (this.f141s[_i] == null) {
                        this.f141s[_i] = new DfsInfo200();
                    }
                    this.f141s[_i].decode(_src);
                }
            }
        }
    }
    ...
    public static class DfsEnumArray300 extends NdrObject {
        public int count;
        public DfsInfo300[] f142s;

        public void encode(NdrBuffer _dst) throws NdrException {
            _dst.align(netdfs.DFS_STORAGE_STATE_ACTIVE);
            _dst.enc_ndr_long(this.count);
            _dst.enc_ndr_referent(this.f142s, netdfs.DFS_STORAGE_STATE_OFFLINE);
            if (this.f142s != null) {
                _dst = _dst.deferred;
                int _ss = this.count;
                _dst.enc_ndr_long(_ss);
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_src.dec_ndr_long() != 0) {
                ...
                if (this.f142s == null) {
                    ...
                    this.f142s = new DfsInfo300[_ss];
                }
                _src = _src.derive(_si);
                for (int _i = 0; _i < _ss; _i += netdfs.DFS_STORAGE_STATE_OFFLINE) {
                    if (this.f142s[_i] == null) {
                        this.f142s[_i] = new DfsInfo300();
                    }
                    this.f142s[_i].decode(_src);
                }
            }
        }
    }
    ...
    public static class DfsEnumArray3 extends NdrObject {
        public int count;
        public DfsInfo3[] f143s;

        public void encode(NdrBuffer _dst) throws NdrException {
            _dst.align(netdfs.DFS_STORAGE_STATE_ACTIVE);
            _dst.enc_ndr_long(this.count);
            _dst.enc_ndr_referent(this.f143s, netdfs.DFS_STORAGE_STATE_OFFLINE);
            if (this.f143s != null) {
                _dst = _dst.deferred;
                int _ss = this.count;
                _dst.enc_ndr_long(_ss);
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_src.dec_ndr_long() != 0) {
                ...
                if (this.f143s == null) {
                    ...
                    this.f143s = new DfsInfo3[_ss];
                }
                _src = _src.derive(_si);
                for (int _i = 0; _i < _ss; _i += netdfs.DFS_STORAGE_STATE_OFFLINE) {
                    if (this.f143s[_i] == null) {
                        this.f143s[_i] = new DfsInfo3();
                    }
                    this.f143s[_i].decode(_src);
                }
            }
        }
    }
    ...
    public static class DfsEnumStruct extends NdrObject {
        ...
        public void encode(NdrBuffer _dst) throws NdrException {
            ...
            _dst.enc_ndr_long(this.level);
            _dst.enc_ndr_referent(this.f144e, netdfs.DFS_STORAGE_STATE_OFFLINE);
            if (this.f144e != null) {
                this.f144e.encode(_dst.deferred);
            }
        }
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_src.dec_ndr_long() != 0) {
                if (this.f144e == null) {
                    this.f144e = new DfsEnumArray1();
                }
                this.f144e.decode(_src.deferred);
            }
        }
    }
    ...
    public static class DfsInfo3 extends NdrObject {
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_storesp != 0) {
                ...
                if (this.stores == null) {
                    if (_storess < 0 || _storess > SupportMenu.USER_MASK) {
                        throw new NdrException(NdrException.INVALID_CONFORMANCE);
                    }
