...
public class lsarpc {
    ...
    public static class LsarDnsDomainInfo extends NdrObject {
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            unicode_string jcifs_dcerpc_rpc_unicode_string = this.name;
            jcifs_dcerpc_rpc_unicode_string.length = (short) _src.dec_ndr_short();
            jcifs_dcerpc_rpc_unicode_string = this.name;
            jcifs_dcerpc_rpc_unicode_string.maximum_length = (short) _src.dec_ndr_short();
            int _name_bufferp = _src.dec_ndr_long();
            _src.align(lsarpc.SID_NAME_ALIAS);
            if (this.dns_domain == null) {
                this.dns_domain = new unicode_string();
            }
            jcifs_dcerpc_rpc_unicode_string = this.dns_domain;
            jcifs_dcerpc_rpc_unicode_string.length = (short) _src.dec_ndr_short();
            jcifs_dcerpc_rpc_unicode_string = this.dns_domain;
            jcifs_dcerpc_rpc_unicode_string.maximum_length = (short) _src.dec_ndr_short();
            ...
            jcifs_dcerpc_rpc_unicode_string = this.dns_forest;
            jcifs_dcerpc_rpc_unicode_string.length = (short) _src.dec_ndr_short();
            jcifs_dcerpc_rpc_unicode_string = this.dns_forest;
            jcifs_dcerpc_rpc_unicode_string.maximum_length = (short) _src.dec_ndr_short();
            ...
            uuid_t jcifs_dcerpc_rpc_uuid_t = this.domain_guid;
            jcifs_dcerpc_rpc_uuid_t.time_low = _src.dec_ndr_long();
            jcifs_dcerpc_rpc_uuid_t = this.domain_guid;
            jcifs_dcerpc_rpc_uuid_t.time_mid = (short) _src.dec_ndr_short();
            jcifs_dcerpc_rpc_uuid_t = this.domain_guid;
            jcifs_dcerpc_rpc_uuid_t.time_hi_and_version = (short) _src.dec_ndr_short();
            jcifs_dcerpc_rpc_uuid_t = this.domain_guid;
            jcifs_dcerpc_rpc_uuid_t.clock_seq_hi_and_reserved = (byte) _src.dec_ndr_small();
            jcifs_dcerpc_rpc_uuid_t = this.domain_guid;
            jcifs_dcerpc_rpc_uuid_t.clock_seq_low = (byte) _src.dec_ndr_small();
            ...
            if (_name_bufferp != 0) {
                ...
                if (this.name.buffer == null) {
                    ...
                    short[] sArr = new short[_name_buffers];
                    this.name.buffer = sArr;
                }
            ...
            if (_dns_domain_bufferp != 0) {
                ...
                if (this.dns_domain.buffer == null) {
                    ...
                    sArr = new short[_dns_domain_buffers];
                    this.dns_domain.buffer = sArr;
                }
            ...
            if (_dns_forest_bufferp != 0) {
                ...
                if (this.dns_forest.buffer == null) {
                    ...
                    sArr = new short[_dns_forest_buffers];
                    this.dns_forest.buffer = sArr;
                }
            ...
            if (this.domain_guid.node == null) {
                ...
                byte[] bArr = new byte[lsarpc.SID_NAME_DELETED];
                this.domain_guid.node = bArr;
            }
    ...
    public static class LsarDomainInfo extends NdrObject {
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_name_bufferp != 0) {
                ...
                _src.advance(_name_bufferl * lsarpc.SID_NAME_DOM_GRP);
                if (this.name.buffer == null) {
                    if (_name_buffers < 0 || _name_buffers > SupportMenu.USER_MASK) {
                        throw new NdrException(NdrException.INVALID_CONFORMANCE);
                    }
    ...
    public static class LsarRefDomainList extends NdrObject {
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_domainsp != 0) {
                ...
                if (this.domains == null) {
                    if (_domainss < 0 || _domainss > SupportMenu.USER_MASK) {
                        throw new NdrException(NdrException.INVALID_CONFORMANCE);
                    }
    ...
    public static class LsarSidArray extends NdrObject {
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_src.dec_ndr_long() != 0) {
                ...
                if (this.sids == null) {
                    if (_sidss < 0 || _sidss > SupportMenu.USER_MASK) {
                        throw new NdrException(NdrException.INVALID_CONFORMANCE);
                    }
    ...
    public static class LsarTransNameArray extends NdrObject {
        ...
        public void decode(NdrBuffer _src) throws NdrException {
            ...
            if (_src.dec_ndr_long() != 0) {
                ...
                if (this.names == null) {
                    if (_namess < 0 || _namess > SupportMenu.USER_MASK) {
                        throw new NdrException(NdrException.INVALID_CONFORMANCE);
                    }
