...
class NameServiceClient implements Runnable {
    ...
    static {
        ...
        RCV_BUF_SIZE = Config.getInt("jcifs.netbios.rcv_buf_size", DEFAULT_SND_BUF_SIZE);
        SO_TIMEOUT = Config.getInt("jcifs.netbios.soTimeout", DEFAULT_SO_TIMEOUT);
        RETRY_COUNT = Config.getInt("jcifs.netbios.retryCount", RESOLVER_BCAST);
        RETRY_TIMEOUT = Config.getInt("jcifs.netbios.retryTimeout", DEFAULT_RETRY_TIMEOUT);
        LPORT = Config.getInt("jcifs.netbios.lport", RCV_BUF_SIZE);
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    jcifs.netbios.NbtAddress[] getNodeStatus(jcifs.netbios.NbtAddress r12) throws java.net.UnknownHostException {
        /*
        r11 = this;
        r5 = new jcifs.netbios.NodeStatusResponse;
        r5.<init>(r12);
        r4 = new jcifs.netbios.NodeStatusRequest;
        r7 = new jcifs.netbios.Name;
        r8 = "*\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000";
        r9 = 0;
        r10 = 0;
        r7.<init>(r8, r9, r10);
        r4.<init>(r7);
        r7 = r12.getInetAddress();
        r4.addr = r7;
        r2 = RETRY_COUNT;
        r3 = r2;
    L_0x001c:
    ...
    L_0x0020:
        r7 = RETRY_TIMEOUT;	 Catch:{ IOException -> 0x0044 }
        r11.send(r4, r5, r7);	 Catch:{ IOException -> 0x0044 }
        r7 = r5.received;
    ...
    L_0x0068:
        ...
        goto L_0x001c;
        */
        throw new UnsupportedOperationException("Method not decompiled: jcifs.netbios.NameServiceClient.getNodeStatus(jcifs.netbios.NbtAddress):jcifs.netbios.NbtAddress[]");
    }
}
