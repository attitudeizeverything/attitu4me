...
public class SanityCheckRootTools extends Activity {
    ...
    /* renamed from: com.stericson.RootTools.test.SanityCheckRootTools.1 */
    ...
    private class SanityCheckThread extends Thread {
        ...
        /* renamed from: com.stericson.RootTools.test.SanityCheckRootTools.SanityCheckThread.1 */
        class C04581 extends Result {
            C04581() {
            }
        ...
        /* renamed from: com.stericson.RootTools.test.SanityCheckRootTools.SanityCheckThread.2 */
        class C04592 extends Result {
            C04592() {
            }
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    visualUpdate(3, "\n[ Listing of / (callback)]\n");
                    Result result2 = new C04581();
                    RootTools.sendShell("ls /", result2, -1);
                    if (result2.getError() == 0) {
                        visualUpdate(4, "Testing sendShell() for multiple commands");
                        try {
                            visualUpdate(3, "\n[ ps + ls + date / (callback)]\n");
                            Result result22 = new C04592();
                            try {
                                RootTools.sendShell(new String[]{"echo \"* PS:\"", "ps", "echo \"* LS:\"", "ls", "echo \"* DATE:\"", "date"}, 0, result22, -1);
    ...
    protected void print(CharSequence text) {
        ...
        this.mScrollView.post(new C02731());
    }
}
