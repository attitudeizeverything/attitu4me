...
public final class RootToolsInternalMethods {
    ...
    /* renamed from: com.stericson.RootTools.internal.RootToolsInternalMethods.1 */
    class C04251 extends Command {
        final /* synthetic */ List val$result;

        C04251(int x0, String[] x1, List list) {
        ...
        public void output(int arg0, String arg1) {
            RootTools.log(arg1);
            this.val$result.add(arg1);
        }
    }

    /* renamed from: com.stericson.RootTools.internal.RootToolsInternalMethods.2 */
    class C04262 extends Command {
        final /* synthetic */ List val$results;

        C04262(int x0, String[] x1, List list) {
        ...
        public void output(int id, String line) {
            if (id == 3 && !line.trim().equals("") && !line.trim().contains("not found")) {
                this.val$results.add(line);
            }
        }
    }

    /* renamed from: com.stericson.RootTools.internal.RootToolsInternalMethods.3 */
    class C04273 extends Command {
        C04273(int x0, String... x1) {
            super(x0, x1);
        }
    ...
    /* renamed from: com.stericson.RootTools.internal.RootToolsInternalMethods.4 */
    class C04284 extends Command {
        C04284(int x0, String... x1) {
            super(x0, x1);
        }
    ...
    /* renamed from: com.stericson.RootTools.internal.RootToolsInternalMethods.5 */
    class C04295 extends Command {
        C04295(int x0, String... x1) {
            super(x0, x1);
        }
    ...
    /* renamed from: com.stericson.RootTools.internal.RootToolsInternalMethods.6 */
    class C04306 extends Command {
        C04306(int x0, String... x1) {
            super(x0, x1);
        }
    ...
    /* renamed from: com.stericson.RootTools.internal.RootToolsInternalMethods.7 */
    class C04317 extends Command {
        C04317(int x0, String... x1) {
            super(x0, x1);
        }
    ...
    /* renamed from: com.stericson.RootTools.internal.RootToolsInternalMethods.8 */
    class C04328 extends Command {
        final /* synthetic */ List val$results;

        C04328(int x0, String[] x1, List list) {
            this.val$results = list;
            super(x0, x1);
        }
    ...
    /* renamed from: com.stericson.RootTools.internal.RootToolsInternalMethods.9 */
    class C04339 extends Command {
        final /* synthetic */ String val$box;
        final /* synthetic */ String val$util;

        C04339(int x0, String[] x1, String str, String str2) {
            this.val$box = str;
            this.val$util = str2;
            super(x0, x1);
        }
        ...
        public void output(int id, String line) {
            if (this.val$box.endsWith("toolbox")) {
                if (line.contains("no such tool")) {
                    InternalVariables.found = true;
                }
            } else if (this.val$box.endsWith("busybox") && line.contains(this.val$util)) {
    ...
    /* renamed from: com.stericson.RootTools.internal.RootToolsInternalMethods.10 */
    class AnonymousClass10 extends Result {
        ...
        public void process(String line) throws Exception {
            if (line.contains(this.val$processName)) {
    ...
    /* renamed from: com.stericson.RootTools.internal.RootToolsInternalMethods.11 */
    class AnonymousClass11 extends Result {
        final /* synthetic */ String val$processName;
    ...
    public boolean exists(String file) {
        ...
        Command command = new C04251(0, new String[]{"ls " + file}, result);
        try {
    ...
    public List<String> getBusyBoxApplets(String path) throws Exception {
        ...
        Command command = new C04262(3, new String[]{path + "busybox --list"}, results);
    ...
    public String getBusyBoxVersion(String path) {
        ...
        try {
            Command command = new C04273(4, path + "busybox");
            Shell.startRootShell().add(command);
            command.waitForFinish();
    ...
    public String getInode(String file) {
        try {
            Command command = new C04284(5, "/data/local/ls -i " + file);
            Shell.startRootShell().add(command);
            command.waitForFinish();
    ...
    public boolean isAccessGiven() {
        try {
            ...
            Command command = new C04295(2, "id");
            Shell.startRootShell().add(command);
            command.waitForFinish();
            if (InternalVariables.accessGiven) {
                return true;
    ...
    public Permissions getFilePermissionsSymlinks(String file) {
        ...
        try {
            Command command = new C04306(1, "ls -l " + file, "busybox ls -l " + file, "/system/bin/failsafe/toolbox ls -l " + file, "toolbox ls -l " + file);
            Shell.startRootShell().add(command);
            command.waitForFinish();
    ...
    public ArrayList<Mount> getMounts() throws Exception {
        ...
        CommandCapture cmd = new CommandCapture(0, "cat /proc/mounts > /data/local/RootToolsMounts", "chmod 0777 /data/local/RootToolsMounts");
        shell.add(cmd);
        cmd.waitForFinish();
    ...
    public long getSpace(String path) {
        ...
        try {
            Command command = new C04317(6, "df " + path);
            Shell.startRootShell().add(command);
            command.waitForFinish();
        } catch (Exception e) {
        }
    ...
    public String getSymlink(String file) {
        ...
        try {
            List<String> results = new ArrayList();
            Command command = new C04328(7, new String[]{"ls -l " + file}, results);
            Shell.startRootShell().add(command);
            command.waitForFinish();
    ...
    public boolean hasUtil(String util, String box) {
        ...
        try {
            ...
            strArr[0] = str;
            RootTools.getShell(true).add(new C04339(0, strArr, box, util)).waitForFinish(NanoHTTPD.SOCKET_READ_TIMEOUT);
    ...
    public boolean isProcessRunning(String processName) {
        ...
        try {
            Result result = new AnonymousClass10(processName);
    ...
    public boolean killProcess(String processName) {
        ...
        try {
            Result result = new AnonymousClass11(processName);
            RootTools.sendShell(new String[]{"ps"}, 1, result, -1);
