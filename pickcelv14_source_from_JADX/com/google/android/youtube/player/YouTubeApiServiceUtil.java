...
public final class YouTubeApiServiceUtil {
    ...
    public static YouTubeInitializationResult isYouTubeApiServiceAvailable(Context context) {
        try {
            ...
            String a = C0084z.m120a(context);
            return !m0a(packageManager.getPackageInfo(a, 64)) ? YouTubeInitializationResult.SERVICE_INVALID : C0084z.m121a(context, a) ? YouTubeInitializationResult.SERVICE_VERSION_UPDATE_REQUIRED : !packageManager.getApplicationInfo(a, 0).enabled ? YouTubeInitializationResult.SERVICE_DISABLED : YouTubeInitializationResult.SUCCESS;
