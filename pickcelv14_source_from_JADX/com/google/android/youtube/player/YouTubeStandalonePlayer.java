...
public final class YouTubeStandalonePlayer {
    ...
    private static Intent m15a(Intent intent, Activity activity, String str, int i, boolean z, boolean z2) {
        YouTubeIntents.m7a(intent, (Context) activity).putExtra("developer_key", str).putExtra("autoplay", z).putExtra("lightbox_mode", z2).putExtra("start_time_millis", i).putExtra("window_has_status_bar", (activity.getWindow().getAttributes().flags & HttpTransport.DEFAULT_CHUNK_LENGTH) == 0);
        return intent;
    }
    ...
    public static Intent createPlaylistIntent(Activity activity, String str, String str2, int i, int i2, boolean z, boolean z2) {
        if (str2 == null) {
            ...
            return m15a(new Intent("com.google.android.youtube.api.StandalonePlayerActivity.START").putExtra("playlist_id", str2).putExtra("current_index", i), activity, str, i2, z, z2);
        } else {
    ...
    public static Intent createVideoIntent(Activity activity, String str, String str2, int i, boolean z, boolean z2) {
        if (str2 == null) {
            ...
            return m15a(new Intent("com.google.android.youtube.api.StandalonePlayerActivity.START").putExtra("video_id", str2), activity, str, i, z, z2);
        } else {
            throw new NullPointerException("The developerKey cannot be null");
        }
    }
    ...
    public static Intent createVideosIntent(Activity activity, String str, List<String> list, int i, int i2, boolean z, boolean z2) {
        if (list == null) {
            ...
            return m15a(new Intent("com.google.android.youtube.api.StandalonePlayerActivity.START").putStringArrayListExtra("video_ids", new ArrayList(list)).putExtra("current_index", i), activity, str, i2, z, z2);
        } else {
            throw new NullPointerException("The developerKey cannot be null");
        }
    }
