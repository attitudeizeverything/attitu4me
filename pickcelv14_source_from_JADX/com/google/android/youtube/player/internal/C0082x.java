...
public final class C0082x {
    public static Map<String, String> m114a(Locale locale) {
        ...
        C0082x.m115a(hashMap, locale.getLanguage());
        String valueOf = String.valueOf(locale.getLanguage());
        String valueOf2 = String.valueOf(locale.getCountry());
        C0082x.m115a(hashMap, new StringBuilder((String.valueOf(valueOf).length() + 1) + String.valueOf(valueOf2).length()).append(valueOf).append("_").append(valueOf2).toString());
        return hashMap;
    }

    private static void m115a(Map<String, String> map, String str) {
        if ("af".equals(str)) {
