...
public class JsonReader implements Closeable {
    ...
    static class C04101 extends JsonReaderInternalAccess {
        C04101() {
        }
    ...
    static {
        NON_EXECUTE_PREFIX = ")]}'\n".toCharArray();
        JsonReaderInternalAccess.INSTANCE = new C04101();
    }

    public JsonReader(Reader in) {
        this.lenient = false;
        this.buffer = new char[HttpTransport.DEFAULT_CHUNK_LENGTH];
