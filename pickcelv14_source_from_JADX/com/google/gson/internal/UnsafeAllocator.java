...
public abstract class UnsafeAllocator {
    ...
    static class C03901 extends UnsafeAllocator {
        final /* synthetic */ Method val$allocateInstance;
        final /* synthetic */ Object val$unsafe;

        C03901(Method method, Object obj) {
    ...
    static class C03912 extends UnsafeAllocator {
        final /* synthetic */ Method val$newInstance;

        C03912(Method method) {
    ...
    static class C03923 extends UnsafeAllocator {
        final /* synthetic */ int val$constructorId;
        final /* synthetic */ Method val$newInstance;

        C03923(Method method, int i) {
            this.val$newInstance = method;
    ...
    static class C03934 extends UnsafeAllocator {
        C03934() {
        }
    ...
    public static UnsafeAllocator create() {
        try {
            ...
            return new C03901(unsafeClass.getMethod("allocateInstance", new Class[]{Class.class}), f.get(null));
        } catch (Exception e) {
            Method newInstance;
            try {
                newInstance = ObjectInputStream.class.getDeclaredMethod("newInstance", new Class[]{Class.class, Class.class});
                newInstance.setAccessible(true);
                return new C03912(newInstance);
            } catch (Exception e2) {
                try {
                    ...
                    newInstance.setAccessible(true);
                    return new C03923(newInstance, constructorId);
                } catch (Exception e3) {
                    return new C03934();
                }
            }
