...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    static class C00861 implements Comparator<Comparable> {
        C00861() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C03881 extends LinkedTreeMapIterator<Entry<K, V>> {
            C03881() {
                super(null);
            }
    ...
    class KeySet extends AbstractSet<K> {
        ...
        class C03891 extends LinkedTreeMapIterator<K> {
            C03891() {
                super(null);
            }
