...
public final class HttpResponseCache extends ResponseCache {
    ...
    class C02582 extends FilterInputStream {
        private final /* synthetic */ Snapshot val$snapshot;

        C02582(InputStream $anonymous0, Snapshot snapshot) {
    ...
    private final class CacheRequestImpl extends CacheRequest {
        ...
        class C02591 extends FilterOutputStream {
            private final /* synthetic */ Editor val$editor;

            C02591(OutputStream $anonymous0, Editor editor) {
        ...
        public CacheRequestImpl(Editor editor) throws IOException {
            ...
            this.body = new C02591(this.cacheOut, editor);
        }
    ...
    class C04131 implements OkResponseCache {
        C04131() {
        }
    ...
    public HttpResponseCache(File directory, long maxSize) throws IOException {
        this.okResponseCache = new C04131();
    ...
    private static InputStream newBodyInputStream(Snapshot snapshot) {
        return new C02582(snapshot.getInputStream(ENTRY_BODY), snapshot);
    }
}
