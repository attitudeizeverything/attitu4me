...
final class Request {
    ...
    public static abstract class Body {
        ...
        class C04152 extends Body {
            private final /* synthetic */ MediaType val$contentType;
            private final /* synthetic */ File val$file;

            C04152(MediaType mediaType, File file) {
                this.val$contentType = mediaType;
                this.val$file = file;
            }
        ...
        public static Body create(MediaType contentType, byte[] content) {
            if (contentType == null) {
                ...
                return new C04141(contentType, content);
            } else {
        ...
        public static Body create(MediaType contentType, File file) {
            if (contentType == null) {
                ...
                return new C04152(contentType, file);
            } else {
                throw new NullPointerException("content == null");
            }
        }
