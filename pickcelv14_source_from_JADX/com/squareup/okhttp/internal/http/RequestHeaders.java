...
public final class RequestHeaders {
    ...
    class C04181 implements CacheControlHandler {
        C04181() {
        }
    ...
    public RequestHeaders(URI uri, RawHeaders headers) {
        ...
        CacheControlHandler handler = new C04181();
    ...
    public void setContentType(String contentType) {
        if (this.contentType != null) {
            this.headers.removeAll(MIME.CONTENT_TYPE);
        }
        this.headers.add(MIME.CONTENT_TYPE, contentType);
