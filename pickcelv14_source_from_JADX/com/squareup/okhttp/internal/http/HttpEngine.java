...
public class HttpEngine {
    ...
    class C02661 extends CacheResponse {
        C02661() {
        }
    ...
    static {
        GATEWAY_TIMEOUT_RESPONSE = new C02661();
    }
    ...
    public final boolean hasResponseBody() {
        ...
        if ((responseCode < HTTP_CONTINUE || responseCode >= 200) && responseCode != 204 && responseCode != MKeyEvent.KEYCODE_MSTAR_UPDATE) {
            return true;
        }
