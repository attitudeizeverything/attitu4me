...
public class HttpURLConnectionImpl extends HttpURLConnection implements Policy {
        ...
        while (true) {
            if (execute(true)) {
                ...
                if (retry != Retry.NONE) {
                    ...
                    if (responseCode == 300 || responseCode == MKeyEvent.KEYCODE_MSTAR_BALANCE || responseCode == MKeyEvent.KEYCODE_MSTAR_INDEX || responseCode == MKeyEvent.KEYCODE_MSTAR_HOLD) {
                        retryMethod = "GET";
                        requestBody = null;
                    }
    ...
    private Retry processResponseHeaders() throws IOException {
        ...
        switch (responseCode) {
            case 300:
            case MKeyEvent.KEYCODE_MSTAR_BALANCE /*301*/:
            case MKeyEvent.KEYCODE_MSTAR_INDEX /*302*/:
            case MKeyEvent.KEYCODE_MSTAR_HOLD /*303*/:
            ...
            case MKeyEvent.KEYCODE_HAIER_TASK /*401*/:
                break;
            case 407:
