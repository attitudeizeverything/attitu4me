...
public final class Util {
    ...
    class C02641 implements ThreadFactory {
    ...
    public static void pokeInt(byte[] dst, int offset, int value, ByteOrder order) {
        if (order == ByteOrder.BIG_ENDIAN) {
            int i = offset + 1;
            dst[offset] = (byte) ((value >> 24) & MKeyEvent.KEYCODE_SLEEP);
            offset = i + 1;
            dst[i] = (byte) ((value >> 16) & MKeyEvent.KEYCODE_SLEEP);
            i = offset + 1;
            dst[offset] = (byte) ((value >> 8) & MKeyEvent.KEYCODE_SLEEP);
            dst[i] = (byte) ((value >> 0) & MKeyEvent.KEYCODE_SLEEP);
            offset = i;
            return;
        }
        i = offset + 1;
        dst[offset] = (byte) ((value >> 0) & MKeyEvent.KEYCODE_SLEEP);
        offset = i + 1;
        dst[i] = (byte) ((value >> 8) & MKeyEvent.KEYCODE_SLEEP);
        i = offset + 1;
        dst[offset] = (byte) ((value >> 16) & MKeyEvent.KEYCODE_SLEEP);
        dst[i] = (byte) ((value >> 24) & MKeyEvent.KEYCODE_SLEEP);
        offset = i;
    }
    ...
    public static int readSingleByte(InputStream in) throws IOException {
        ...
        if (in.read(buffer, 0, 1) != -1) {
            return buffer[0] & MKeyEvent.KEYCODE_SLEEP;
        }
        return -1;
    }

    public static void writeSingleByte(OutputStream out, int b) throws IOException {
        out.write(new byte[]{(byte) (b & MKeyEvent.KEYCODE_SLEEP)});
    }
    ...
    public static long skipByReading(InputStream in, long byteCount) throws IOException {
        ...
        if (byteCount != 0) {
            ...
            if (buffer == null) {
                buffer = new byte[SmbConstants.FLAGS2_RESOLVE_PATHS_IN_DFS];
            }
            j = 0;
            while (j < byteCount) {
