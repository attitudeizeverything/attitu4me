    ...
    static final class Reader implements FrameReader {
        ...
        public boolean nextFrame(Handler handler) throws IOException {
            ...
            try {
                ...
                int streamId = w1 & Constants.CONNECTION_OK;
        ...
        private void readSynStream(Handler handler, int flags, int length) throws IOException {
            ...
            int streamId = w1 & Constants.CONNECTION_OK;
            int associatedStreamId = w2 & Constants.CONNECTION_OK;
            int priority = (57344 & s3) >>> 13;
            int slot = s3 & MKeyEvent.KEYCODE_SLEEP;
        ...
        private void readSynReply(Handler handler, int flags, int length) throws IOException {
            boolean inFinished;
            int streamId = this.in.readInt() & Constants.CONNECTION_OK;
        ...
        private void readHeaders(Handler handler, int flags, int length) throws IOException {
            handler.headers(false, false, this.in.readInt() & Constants.CONNECTION_OK, -1, -1, this.nameValueBlockReader.readNameValueBlock(length - 4), HeadersMode.SPDY_HEADERS);
        }
        ...
        private void readWindowUpdate(Handler handler, int flags, int length) throws IOException {
            ...
            handler.windowUpdate(this.in.readInt() & Constants.CONNECTION_OK, this.in.readInt() & Constants.CONNECTION_OK, false);
        }
        ...
        private void readGoAway(Handler handler, int flags, int length) throws IOException {
            ...
            int lastGoodStreamId = this.in.readInt() & Constants.CONNECTION_OK;
            int errorCodeInt = this.in.readInt();
    ...
    static final class Writer implements FrameWriter {
        ...
        public synchronized void synStream(boolean outFinished, boolean inFinished, int streamId, int associatedStreamId, int priority, int slot, List<String> nameValueBlock) throws IOException {
            ...
            synchronized (this) {
                ...
                this.out.writeInt(((flags & MKeyEvent.KEYCODE_SLEEP) << 24) | (ViewCompat.MEASURED_SIZE_MASK & length));
                this.out.writeInt(streamId & Constants.CONNECTION_OK);
                this.out.writeInt(associatedStreamId & Constants.CONNECTION_OK);
                this.out.writeShort((((priority & Spdy3.TYPE_GOAWAY) << 13) | Spdy3.TYPE_DATA) | (slot & MKeyEvent.KEYCODE_SLEEP));
        ...
        public synchronized void synReply(boolean outFinished, int streamId, List<String> nameValueBlock) throws IOException {
            ...
            this.out.writeInt(((flags & MKeyEvent.KEYCODE_SLEEP) << 24) | (ViewCompat.MEASURED_SIZE_MASK & length));
            this.out.writeInt(Constants.CONNECTION_OK & streamId);
            this.nameValueBlockBuffer.writeTo(this.out);
            this.out.flush();
        }
        ...
        public synchronized void data(boolean outFinished, int streamId, byte[] data, int offset, int byteCount) throws IOException {
            int flags = outFinished ? Spdy3.TYPE_SYN_STREAM : Spdy3.TYPE_DATA;
            this.out.writeInt(Constants.CONNECTION_OK & streamId);
            this.out.writeInt(((flags & MKeyEvent.KEYCODE_SLEEP) << 24) | (ViewCompat.MEASURED_SIZE_MASK & byteCount));
        ...
        public synchronized void settings(Settings settings) throws IOException {
            ...
            for (int i = Spdy3.TYPE_DATA; i <= 10; i += Spdy3.TYPE_SYN_STREAM) {
                if (settings.isSet(i)) {
                    this.out.writeInt(((settings.flags(i) & MKeyEvent.KEYCODE_SLEEP) << 24) | (i & ViewCompat.MEASURED_SIZE_MASK));
