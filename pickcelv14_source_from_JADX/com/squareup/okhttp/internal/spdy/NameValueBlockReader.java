...
class NameValueBlockReader implements Closeable {
    ...
    class C02681 extends InputStream {
        private final /* synthetic */ InputStream val$in;

        C02681(InputStream inputStream) {
    ...
    NameValueBlockReader(InputStream in) {
        this.fillableInflaterInputStream = new FillableInflaterInputStream(new C02681(in), new C02692());
