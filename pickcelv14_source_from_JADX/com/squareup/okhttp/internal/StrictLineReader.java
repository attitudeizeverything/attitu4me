...
public class StrictLineReader implements Closeable {
    ...
    /* renamed from: com.squareup.okhttp.internal.StrictLineReader.1 */
    class C02631 extends ByteArrayOutputStream {
        C02631(int $anonymous0) {
            super($anonymous0);
        }
    ...
    public StrictLineReader(InputStream in, Charset charset) {
        this(in, HTTPSession.BUFSIZE, charset);
    }
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.in) {
            ...
            ByteArrayOutputStream out = new C02631((this.end - this.pos) + 80);
            loop1:
            while (true) {
