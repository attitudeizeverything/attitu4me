...
public class FileUtils extends CordovaPlugin {
    ...
    class AnonymousClass12 implements FileOp {
        private final /* synthetic */ CallbackContext val$callbackContext;
        private final /* synthetic */ int val$fstype;
    ...
    class C04341 implements FileOp {
        private final /* synthetic */ CallbackContext val$callbackContext;

        C04341(CallbackContext callbackContext) {
            this.val$callbackContext = callbackContext;
        }
    ...
    class AnonymousClass20 implements FileOp {
        ...
        private final /* synthetic */ String val$newParent;
    ...
    class AnonymousClass23 implements FileOp {
        private final /* synthetic */ CallbackContext val$callbackContext;
        private final /* synthetic */ String val$localURLstr;
    ...
    class AnonymousClass25 implements ReadFileCallback {
        ...
        public void handleData(InputStream inputStream, String contentType) {
            try {
                ...
                byte[] buffer = new byte[HTTPSession.BUFSIZE];
                while (true) {
                    int bytesRead = inputStream.read(buffer, 0, HTTPSession.BUFSIZE);
                    if (bytesRead <= 0) {
                        break;
                    }
    ...
    class C04352 implements FileOp {
        private final /* synthetic */ CallbackContext val$callbackContext;

        C04352(CallbackContext callbackContext) {
            this.val$callbackContext = callbackContext;
        }
    ...
    class C04363 implements FileOp {
        private final /* synthetic */ CallbackContext val$callbackContext;
        private final /* synthetic */ String val$fname;

        C04363(String str, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$callbackContext = callbackContext;
        }
    ...
    class C04374 implements FileOp {
        private final /* synthetic */ CallbackContext val$callbackContext;
        private final /* synthetic */ String val$fname;

        C04374(String str, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$callbackContext = callbackContext;
        }
    ...
    class C04385 implements FileOp {
        private final /* synthetic */ CallbackContext val$callbackContext;
        private final /* synthetic */ String val$encoding;
        ...
        C04385(String str, int i, int i2, CallbackContext callbackContext, String str2) {
            this.val$fname = str;
            this.val$start = i;
            this.val$end = i2;
            this.val$callbackContext = callbackContext;
    ...
    class C04396 implements FileOp {
        private final /* synthetic */ CallbackContext val$callbackContext;
        private final /* synthetic */ int val$end;
        private final /* synthetic */ String val$fname;
        private final /* synthetic */ int val$start;

        C04396(String str, int i, int i2, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$start = i;
            this.val$end = i2;
            this.val$callbackContext = callbackContext;
    ...
    class C04407 implements FileOp {
        private final /* synthetic */ CallbackContext val$callbackContext;
        private final /* synthetic */ int val$end;
        private final /* synthetic */ String val$fname;
        private final /* synthetic */ int val$start;

        C04407(String str, int i, int i2, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$start = i;
            this.val$end = i2;
            this.val$callbackContext = callbackContext;
    ...
    class C04418 implements FileOp {
        private final /* synthetic */ CallbackContext val$callbackContext;
        private final /* synthetic */ int val$end;
        private final /* synthetic */ String val$fname;
        private final /* synthetic */ int val$start;

        C04418(String str, int i, int i2, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$start = i;
            this.val$end = i2;
            this.val$callbackContext = callbackContext;
    ...
    class C04429 implements FileOp {
        private final /* synthetic */ CallbackContext val$callbackContext;
        private final /* synthetic */ String val$data;
        private final /* synthetic */ String val$fname;
        private final /* synthetic */ Boolean val$isBinary;
        private final /* synthetic */ int val$offset;

        C04429(String str, String str2, int i, Boolean bool, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$data = str2;
            this.val$offset = i;
    ...
    static {
        ...
        PATH_EXISTS_ERR = 12;
        UNKNOWN_ERR = MMediaPlayer.MEDIA_INFO_SUBTITLE_UPDATA;
    }
    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        ...
        if ("internal".equalsIgnoreCase(location)) {
            persistentRoot = new StringBuilder(String.valueOf(activity.getFilesDir().getAbsolutePath())).append("/files/").toString();
            this.configured = true;
        } else if ("compatibility".equalsIgnoreCase(location)) {
            if (Environment.getExternalStorageState().equals("mounted")) {
                persistentRoot = Environment.getExternalStorageDirectory().getAbsolutePath();
                tempRoot = new StringBuilder(String.valueOf(Environment.getExternalStorageDirectory().getAbsolutePath())).append("/Android/data/").append(packageName).append("/cache/").toString();
            } else {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        if (this.configured) {
            if (action.equals("testSaveLocationExists")) {
                threadhelper(new C04341(callbackContext), callbackContext);
            } else {
                if (action.equals("getFreeDiskSpace")) {
                    threadhelper(new C04352(callbackContext), callbackContext);
                } else {
                    if (action.equals("testFileExists")) {
                        threadhelper(new C04363(args.getString(0), callbackContext), callbackContext);
                    } else {
                        if (action.equals("testDirectoryExists")) {
                            threadhelper(new C04374(args.getString(0), callbackContext), callbackContext);
                        } else {
                            if (action.equals("readAsText")) {
                                String encoding = args.getString(1);
                                threadhelper(new C04385(args.getString(0), args.getInt(2), args.getInt(3), callbackContext, encoding), callbackContext);
                            } else {
                                if (action.equals("readAsDataURL")) {
                                    threadhelper(new C04396(args.getString(0), args.getInt(1), args.getInt(2), callbackContext), callbackContext);
                                } else {
                                    if (action.equals("readAsArrayBuffer")) {
                                        threadhelper(new C04407(args.getString(0), args.getInt(1), args.getInt(2), callbackContext), callbackContext);
                                    } else {
                                        if (action.equals("readAsBinaryString")) {
                                            threadhelper(new C04418(args.getString(0), args.getInt(1), args.getInt(2), callbackContext), callbackContext);
                                        } else {
                                            if (action.equals("write")) {
                                                String string = args.getString(0);
                                                threadhelper(new C04429(fname, args.getString(1), args.getInt(2), Boolean.valueOf(args.getBoolean(3)), callbackContext), callbackContext);
                                            } else {
    ...
    private static String toDirUrl(File f) {
        return new StringBuilder(String.valueOf(Uri.fromFile(f).toString())).append('/').toString();
    }
    ...
    public long write(String srcURLstr, String data, int offset, boolean isBinary) throws FileNotFoundException, IOException, NoModificationAllowedException {
        try {
            ...
            Log.d("TEST", new StringBuilder(String.valueOf(srcURLstr)).append(": ").append(x).toString());
            return x;
        } catch (IllegalArgumentException e) {
            throw new MalformedURLException("Unrecognized filesystem URL");
        }
