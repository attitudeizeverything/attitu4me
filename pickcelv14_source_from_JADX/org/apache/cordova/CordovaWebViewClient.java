...
public class CordovaWebViewClient extends WebViewClient {
    ...
    class C03041 implements Runnable {
        ...
        public void run() {
            try {
                Thread.sleep(2000);
                CordovaWebViewClient.this.cordova.getActivity().runOnUiThread(new C03031());
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        ...
        LOG.m129d(TAG, "onPageStarted(" + url + ")");
    ...
    public void onPageFinished(WebView view, String url) {
        ...
        if (this.isCurrentlyLoading || url.startsWith("about:")) {
            ...
            LOG.m129d(TAG, "onPageFinished(" + url + ")");
    ...
    public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
        if (this.isCurrentlyLoading) {
            LOG.m131d(TAG, "CordovaWebViewClient.onReceivedError: Error code=%s Description=%s URL=%s", Integer.valueOf(errorCode), description, failingUrl);
            CordovaWebView cordovaWebView = this.appView;
            cordovaWebView.loadUrlTimeout++;
            if (errorCode == -10) {
                if (view.canGoBack()) {
