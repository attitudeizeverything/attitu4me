...
public class CordovaActivity extends Activity implements CordovaInterface {
    ...
    class C02861 implements Runnable {
        ...
        C02861(CordovaActivity cordovaActivity, String str) {
    ...
    class C02872 implements Runnable {
        ...
        C02872(boolean z, CordovaActivity cordovaActivity, String str, String str2) {
            this.val$exit = z;
            this.val$me = cordovaActivity;
    ...
    class C02893 implements Runnable {
        ...
        class C02881 implements OnClickListener {
            ...
            C02881(boolean z, CordovaActivity cordovaActivity) {
                this.val$exit = z;
                this.val$me = cordovaActivity;
            }
        ...
        C02893(CordovaActivity cordovaActivity, String str, String str2, String str3, boolean z) {
            this.val$me = cordovaActivity;
        ...
        public void run() {
            try {
                ...
                dlg.setPositiveButton(this.val$button, new C02881(this.val$exit, this.val$me));
                dlg.create();
                dlg.show();
            } catch (Exception e) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        LOG.m135i(TAG, "Apache Cordova native platform version 3.7.2 is starting");
        LOG.m129d(TAG, "CordovaActivity.onCreate()");
        loadConfig();
        ...
        if (this.preferences.getBoolean("SetFullscreen", false)) {
            ...
            getWindow().setFlags(SmbConstants.FLAGS2_EXTENDED_SECURITY_NEGOTIATION, SmbConstants.FLAGS2_EXTENDED_SECURITY_NEGOTIATION);
        }
    ...
    protected void createViews() {
        LOG.m129d(TAG, "CordovaActivity.createViews()");
        ...
        if (!(parent == null || parent == this.root)) {
            LOG.m129d(TAG, "removing appView from existing parent");
    ...
    public void init(CordovaWebView webView, CordovaWebViewClient webViewClient, CordovaChromeClient webChromeClient) {
        LOG.m129d(TAG, "CordovaActivity.init()");
    ...
    protected void onPause() {
        super.onPause();
        LOG.m129d(TAG, "Paused the application!");
    ...
    protected void onResume() {
        super.onResume();
        LOG.m129d(TAG, "Resuming the App");
    ...
    public void onDestroy() {
        LOG.m129d(TAG, "CordovaActivity.onDestroy()");
        super.onDestroy();
        if (this.appView != null) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        LOG.m129d(TAG, "Incoming Result. Request code = " + requestCode);
        ...
        this.activityResultCallback = null;
        if (callback != null) {
            LOG.m129d(TAG, "We have a callback to send this result to");
            callback.onActivityResult(requestCode, resultCode, intent);
            return;
        }
        LOG.m141w(TAG, "Got an activity result, but no plugin was registered to receive it.");
    }
    ...
    public void onReceivedError(int errorCode, String description, String failingUrl) {
        ...
        if (errorUrl == null || (!(errorUrl.startsWith("file://") || this.internalWhitelist.isUrlWhiteListed(errorUrl)) || failingUrl.equals(errorUrl))) {
            runOnUiThread(new C02872(errorCode != -2, me, description, failingUrl));
        } else {
            runOnUiThread(new C02861(me, errorUrl));
        }
    }

    public void displayError(String title, String message, String button, boolean exit) {
        runOnUiThread(new C02893(this, message, title, button, exit));
    }
    ...
    public Context getContext() {
        LOG.m129d(TAG, "This will be deprecated December 2012");
        return this;
    }
    ...
    public Object onMessage(String id, Object data) {
        if (!"onScrollChanged".equals(id)) {
            LOG.m129d(TAG, "onMessage(" + id + "," + data + ")");
        }
