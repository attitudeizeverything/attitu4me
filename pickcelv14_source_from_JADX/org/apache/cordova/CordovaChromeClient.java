...
public class CordovaChromeClient extends WebChromeClient {
    ...
    class C02912 implements OnCancelListener {
        private final /* synthetic */ JsResult val$result;

        C02912(JsResult jsResult) {
            this.val$result = jsResult;
        }
    ...
    class C02923 implements OnKeyListener {
        private final /* synthetic */ JsResult val$result;

        C02923(JsResult jsResult) {
            this.val$result = jsResult;
        }
    ...
    class C02945 implements OnClickListener {
        private final /* synthetic */ JsResult val$result;

        C02945(JsResult jsResult) {
            this.val$result = jsResult;
        }
    ...
    class C02956 implements OnCancelListener {
        private final /* synthetic */ JsResult val$result;

        C02956(JsResult jsResult) {
            this.val$result = jsResult;
        }
    ...
    class C02967 implements OnKeyListener {
        private final /* synthetic */ JsResult val$result;

        C02967(JsResult jsResult) {
            this.val$result = jsResult;
        }
    ...
    class C02978 implements OnClickListener {
        private final /* synthetic */ EditText val$input;
        private final /* synthetic */ JsPromptResult val$res;

        C02978(EditText editText, JsPromptResult jsPromptResult) {
    ...
    class C02989 implements OnClickListener {
        private final /* synthetic */ JsPromptResult val$res;

        C02989(JsPromptResult jsPromptResult) {
            this.val$res = jsPromptResult;
        }
    ...
    class AnonymousClass10 extends CordovaPlugin {
        private final /* synthetic */ ValueCallback val$uploadMsg;
    ...
    class AnonymousClass11 extends CordovaPlugin {
        private final /* synthetic */ ValueCallback val$filePathsCallback;
    ...
    public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
        ...
        dlg.setPositiveButton(17039370, new C02901(result));
        dlg.setOnCancelListener(new C02912(result));
        dlg.setOnKeyListener(new C02923(result));
    ...
    public boolean onJsConfirm(WebView view, String url, String message, JsResult result) {
        ...
        dlg.setCancelable(true);
        dlg.setPositiveButton(17039370, new C02934(result));
        dlg.setNegativeButton(17039360, new C02945(result));
        dlg.setOnCancelListener(new C02956(result));
        dlg.setOnKeyListener(new C02967(result));
        this.lastHandledDialog = dlg.show();
        return true;
    }
    ...
    public boolean onJsPrompt(WebView view, String origin, String message, String defaultValue, JsPromptResult result) {
        ...
        if (handledRet != null) {
            ...
            dlg.setPositiveButton(17039370, new C02978(input, res));
            dlg.setNegativeButton(17039360, new C02989(res));
            this.lastHandledDialog = dlg.show();
        }
        return true;
    }
    ...
    public void onExceededDatabaseQuota(String url, String databaseIdentifier, long currentQuota, long estimatedSize, long totalUsedQuota, QuotaUpdater quotaUpdater) {
        LOG.m131d(this.TAG, "onExceededDatabaseQuota estimatedSize: %d  currentQuota: %d  totalUsedQuota: %d", Long.valueOf(estimatedSize), Long.valueOf(currentQuota), Long.valueOf(totalUsedQuota));
        quotaUpdater.updateQuota(this.MAX_QUOTA);
    }

    public void onConsoleMessage(String message, int lineNumber, String sourceID) {
        if (VERSION.SDK_INT == 7) {
            LOG.m131d(this.TAG, "%s: Line %d : %s", sourceID, Integer.valueOf(lineNumber), message);
    ...
    public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        if (consoleMessage.message() != null) {
            LOG.m131d(this.TAG, "%s: Line %d : %s", consoleMessage.sourceId(), Integer.valueOf(consoleMessage.lineNumber()), consoleMessage.message());
        }
