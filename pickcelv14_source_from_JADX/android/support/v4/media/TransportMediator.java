...
public class TransportMediator extends TransportController {
    ...
    class C00172 implements Callback {
        C00172() {
        }
    ...
    class C03261 implements TransportMediatorCallback {
        C03261() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C03261();
        this.mKeyEventCallback = new C00172();
