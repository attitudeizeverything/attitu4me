...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    class C00181 implements OnWindowAttachListener {
        C00181() {
        }
    ...
    class C00192 implements OnWindowFocusChangeListener {
        C00192() {
        }
    ...
    class C00214 implements OnAudioFocusChangeListener {
        C00214() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00181();
        this.mWindowFocusListener = new C00192();
        this.mMediaButtonReceiver = new C00203();
        this.mAudioFocusChangeListener = new C00214();
        this.mPlayState = 0;
    ...
    void windowAttached() {
        ...
        this.mPendingIntent = PendingIntent.getBroadcast(this.mContext, 0, this.mIntent, SmbConstants.GENERIC_ALL);
