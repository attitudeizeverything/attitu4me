...
public class ViewPager extends ViewGroup {
    ...
    static class C00341 implements Comparator<ItemInfo> {
        C00341() {
        }
    ...
    static class C00352 implements Interpolator {
        C00352() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C03311 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03311() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C03311());
        }
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == SmbConstants.FLAGS2_RESOLVE_PATHS_IN_DFS && ViewPager.this.mAdapter != null) {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (ViewPager.this.canScrollHorizontally(ViewPager.SCROLL_STATE_DRAGGING)) {
                info.addAction(SmbConstants.FLAGS2_RESOLVE_PATHS_IN_DFS);
            }
            if (ViewPager.this.canScrollHorizontally(ViewPager.INVALID_POINTER)) {
                info.addAction(HTTPSession.BUFSIZE);
            }
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00341();
        sInterpolator = new C00352();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00363();
    ...
    void initViewPager() {
        ...
        setDescendantFocusability(SmbConstants.WRITE_DAC);
        setFocusable(true);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    if (consumeVertical) {
                        widthMode = SmbConstants.GENERIC_WRITE;
                    } else if (consumeHorizontal) {
                        heightMode = SmbConstants.GENERIC_WRITE;
                    }
        ...
        this.mChildWidthMeasureSpec = MeasureSpec.makeMeasureSpec(childWidthSize, SmbConstants.GENERIC_WRITE);
        this.mChildHeightMeasureSpec = MeasureSpec.makeMeasureSpec(childHeightSize, SmbConstants.GENERIC_WRITE);
        this.mInLayout = true;
        populate();
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                lp = (LayoutParams) child.getLayoutParams();
                if (lp == null || !lp.isDecor) {
                    child.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), SmbConstants.GENERIC_WRITE), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                ...
                if (!lp.isDecor) {
                    ...
                    if (ii != null) {
                        ...
                        if (lp.needsMeasure) {
                            ...
                            int makeMeasureSpec = MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp.widthFactor), SmbConstants.GENERIC_WRITE);
                            child.measure(widthSpec, MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, SmbConstants.GENERIC_WRITE));
                        }
                        child.layout(childLeft, childTop, child.getMeasuredWidth() + childLeft, child.getMeasuredHeight() + childTop);
                    }
                }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        int action = ev.getAction() & MKeyEvent.KEYCODE_SLEEP;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (this.mAdapter != null) {
            if (this.mAdapter.getCount() != 0) {
                ...
                float x;
                switch (action & MKeyEvent.KEYCODE_SLEEP) {
                    case SCROLL_STATE_IDLE /*0*/:
                        this.mScroller.abortAnimation();
                        this.mPopulatePending = DEBUG;
                        populate();
                    ...
                    case SCROLL_STATE_DRAGGING /*1*/:
                        if (this.mIsBeingDragged) {
                            ...
                            velocityTracker.computeCurrentVelocity(MMediaPlayer.MEDIA_INFO_SUBTITLE_UPDATA, (float) this.mMaximumVelocity);
    ...
    public void addFocusables(ArrayList<View> views, int direction, int focusableMode) {
        ...
        if ((descendantFocusability == SmbConstants.WRITE_DAC && focusableCount != views.size()) || !isFocusable()) {
            return;
        }
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        if (event.getEventType() == SmbConstants.FLAGS2_RESOLVE_PATHS_IN_DFS) {
