...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    class C00312 implements OnClickListener {
        C00312() {
        }
    ...
    public PagerTabStrip(Context context, AttributeSet attrs) {
        ...
        this.mTabAlpha = MKeyEvent.KEYCODE_SLEEP;
        ...
        this.mPrevText.setOnClickListener(new C00301());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C00312());
