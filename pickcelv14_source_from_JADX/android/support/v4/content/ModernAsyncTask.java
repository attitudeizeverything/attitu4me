...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00141 implements ThreadFactory {
    ...
    class C00153 extends FutureTask<Result> {
        C00153(Callable x0) {
            super(x0);
        }
    ...
    class C03252 extends WorkerRunnable<Params, Result> {
        C03252() {
            super();
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C03252();
        this.mFuture = new C00153(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00164.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
