...
public class ViewDragHelper {
    ...
    static class C00511 implements Interpolator {
        C00511() {
        }
    ...
    private ViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        ...
        this.mSetIdleRunnable = new C00522();
        if (forParent == null) {
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(MMediaPlayer.MEDIA_INFO_SUBTITLE_UPDATA, this.mMaxVelocity);
