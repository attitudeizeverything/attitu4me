...
public class SmbDevice implements Parcelable {
    ...
    /* renamed from: android.net.samba.SmbDevice.1 */
    static class C00041 implements Creator<SmbDevice> {
        C00041() {
        }
    ...
    public java.util.ArrayList<android.net.samba.SmbShareFolder> getSharefolderList() {
        /*
        r15 = this;
        r14 = 0;
        r1 = 0;
    ...
    L_0x010c:
        r10 = new android.net.samba.SmbShareFolder;	 Catch:{ MalformedURLException -> 0x018a, SmbException -> 0x01ed }
    ...
    L_0x016d:
        r10 = new android.net.samba.SmbShareFolder;	 Catch:{ SmbException -> 0x0192, MalformedURLException -> 0x018a }
    ...
    L_0x0208:
        ...
        goto L_0x018e;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.net.samba.SmbDevice.getSharefolderList():java.util.ArrayList<android.net.samba.SmbShareFolder>");
    }
